...
final List<Person> falseData = [
  ...
  Person(
    ...
    tasks: [
      'Sa stea cu nepotul si Jhon pana la sosire',
      'Sa scoata cainele la plimbare',
      'Sa stea de vorba cu el pana la sosire',
    ],
  ),
  Person(
    id: 3,
    ...
    tasks: [
      'Sa aduca pastilele necesare de la farmacaie',
      'Sa scoata cainele la plimbare',
      'Sa o ingrijeasca pana ajungem acasa',
    ],
  ),
  Person(
    id: 4,
